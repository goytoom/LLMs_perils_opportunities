...
```{r}
color_mapping <- list(age = c("LLAMA" = "black", "GPT" = "#e41a1c", "18-24" = "#377eb8", "25-34" = "#4daf4a", "35-54" = "#984ea3", "55-74" = "#ff7f00"),
                      political_opinion = c("LLAMA" = "black","GPT" = "#e41a1c", "Conservative" = "#377eb8", "Liberal" = "#4daf4a", "Moderate" = "#984ea3"),
                      race = c("LLAMA" = "black","GPT" = "#e41a1c", "Asian" = "#377eb8", "Black" = "#4daf4a", "Hispanic" = "#984ea3", "White" = "#ff7f00"),
                      religion = c("LLAMA" = "black","GPT" = "#e41a1c", "Agnostic" = "#377eb8", "Atheist" = "#4daf4a", "Christianity" = "#984ea3"),
                      sex = c("LLAMA" = "black", "GPT" = "#e41a1c", "Male" = "#377eb8", "Female" = "#4daf4a")
                      )
