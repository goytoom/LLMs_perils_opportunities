...
groupComparisons <- function(df, varnames){
  ...
  for(varname in varnames){
    ...
    t1 <- ggplot(df_comparison, aes(x = construct, y = value, fill = group)) +
      ...
      geom_point(aes(x = construct, y = value, colour = group), position = ggpp::position_jitternudge(width=0.05, height=0.075, x = -.25, nudge.from = "jittered"), size = 1, shape = 20, alpha = .3)+
