...
```{r}
results_path_1 = paste(evals_dir, paste("gpt", corp, "success", mode, sep="_"), ".csv", sep="") #chatGPT
results_path_2 = paste(evals_dir, paste("gpt", corp, "success", mode, alt, sep="_"), ".csv", sep="") #chatGPT ALT1
...
for(model in list_models){
  coef_gpt2 = (round(exp(tidy(model)$estimate[2]), 2)-1)*100
  coefList[[length(coefList)+1]] = list(c(coef_gpt2))
  i = i + 1
}
