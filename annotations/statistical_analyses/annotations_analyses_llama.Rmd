...
results_path = paste(evals_dir, paste("llama2", corp, "success", mode, sep="_"), ".csv", sep="") #chatGPT
```
...
```{r}
lm_general <- glm(as.factor(success) ~ annotator, data = df, 
                  family = 'binomial')
...
results_path_2 = paste(evals_dir, paste("llama2", corp, "success", mode, sep="_"), ".csv", sep="") #chatGPT
...
for(model in list_models){
  ...
  coefList[[length(coefList)+1]] = list(c(coef_bert, coef_gpt))
  i = i + 1
}
