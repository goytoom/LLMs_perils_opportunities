...
colnames(df_scores_final) <- c("source", "model", "Tightness",	"Individualism",	"Collectivism",	"Need For Cognition",	"Conservatism",	"Religiosity",	"Care",	"Equality",	"Proportionality",	"Loyalty",	"Authority",	"Purity",	"Self-Direction",	"Power",	"Universalism",	"Achievement",	"Security",	"Stimulation",	"Conformity",	"Tradition",	"Hedonism",	"Benevolenvce")
...
```
### Dedicated Welch's Test (DO NOT ACCOUNT FOR GROUP COMPARISON)
```{r}
### Values
#vs gpt
t.test(df_scores_final_value[df_scores_final_value$model=="ccr", "r2"], df_scores_final_value[df_scores_final_value$model=="gpt", "r2"], alternative = "two.sided")

#vs gpt_ccr
t.test(df_scores_final_value[df_scores_final_value$model=="ccr", "r2"], df_scores_final_value[df_scores_final_value$model=="gpt_ccr", "r2"], alternative = "two.sided")
```
