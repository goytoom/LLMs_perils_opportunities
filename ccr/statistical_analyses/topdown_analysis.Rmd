...
results_path = paste(evals_dir, paste(data, ".csv", sep="") , sep="") #chatGPT

df_results <- read.csv(results_path) # load predictions
print(nrow(df_results %>% distinct(id, source, prompt_type, construct, item)) - nrow(df_results)) #check if queries are doubled
```
...
### GPT item-level models (using responses from CCR style prompts) -- from Values essays
```{r}
#reformat data sets from long to wide for each construct separately
#only use responses from CCR style prompt
df_ccr_cons = df_results %>% filter(construct=="conservatism_tot" & prompt_type=="hybrid" & source=="values") %>% spread(key = "item", value = "prediction_clean")
df_ccr_indi = df_results %>% filter(construct=="Individualism_tot" & prompt_type=="hybrid" & source=="values") %>% spread(key = "item", value = "prediction_clean")
df_ccr_reli = df_results %>% filter(construct=="Religiosity_tot" & prompt_type=="hybrid" & source=="values") %>% spread(key = "item", value = "prediction_clean")
df_ccr_coll = df_results %>% filter(construct=="Collectivism_tot" & prompt_type=="hybrid" & source=="values") %>% spread(key = "item", value = "prediction_clean")
df_ccr_care = df_results %>% filter(construct=="CARE_tot" & prompt_type=="hybrid" & source=="values") %>% spread(key = "item", value = "prediction_clean")
df_ccr_equa = df_results %>% filter(construct=="EQUALITY_tot" & prompt_type=="hybrid" & source=="values") %>% spread(key = "item", value = "prediction_clean")
df_ccr_prop = df_results %>% filter(construct=="PROPORTIONALITY_tot" & prompt_type=="hybrid" & source=="values") %>% spread(key = "item", value = "prediction_clean")
df_ccr_loya = df_results %>% filter(construct=="LOYALTY_tot" & prompt_type=="hybrid" & source=="values") %>% spread(key = "item", value = "prediction_clean")
df_ccr_auth = df_results %>% filter(construct=="AUTHORITY_tot" & prompt_type=="hybrid" & source=="values") %>% spread(key = "item", value = "prediction_clean")
df_ccr_puri = df_results %>% filter(construct=="PURITY_tot" & prompt_type=="hybrid" & source=="values") %>% spread(key = "item", value = "prediction_clean")
df_ccr_nfc = df_results %>% filter(construct=="NFC_tot" & prompt_type=="hybrid" & source=="values") %>% spread(key = "item", value = "prediction_clean")
df_ccr_tigh = df_results %>% filter(construct=="Tightness" & prompt_type=="hybrid" & source=="values") %>% spread(key = "item", value = "prediction_clean")
df_ccr_sd = df_results %>% filter(construct=="PVQ_SD_tot" & prompt_type=="hybrid" & source=="values") %>% spread(key = "item", value = "prediction_clean")
df_ccr_po = df_results %>% filter(construct=="PVQ_PO_tot" & prompt_type=="hybrid" & source=="values") %>% spread(key = "item", value = "prediction_clean")
df_ccr_un = df_results %>% filter(construct=="PVQ_UN_tot" & prompt_type=="hybrid" & source=="values") %>% spread(key = "item", value = "prediction_clean")
df_ccr_ac = df_results %>% filter(construct=="PVQ_AC_tot" & prompt_type=="hybrid" & source=="values") %>% spread(key = "item", value = "prediction_clean")
df_ccr_se = df_results %>% filter(construct=="PVQ_SE_tot" & prompt_type=="hybrid" & source=="values") %>% spread(key = "item", value = "prediction_clean")
df_ccr_st = df_results %>% filter(construct=="PVQ_ST_tot" & prompt_type=="hybrid" & source=="values") %>% spread(key = "item", value = "prediction_clean")
df_ccr_co = df_results %>% filter(construct=="PVQ_CO_tot" & prompt_type=="hybrid" & source=="values") %>% spread(key = "item", value = "prediction_clean")
df_ccr_tr = df_results %>% filter(construct=="PVQ_TR_tot" & prompt_type=="hybrid" & source=="values") %>% spread(key = "item", value = "prediction_clean")
df_ccr_he = df_results %>% filter(construct=="PVQ_HE_tot" & prompt_type=="hybrid" & source=="values") %>% spread(key = "item", value = "prediction_clean")
df_ccr_be = df_results %>% filter(construct=="PVQ_BE_tot" & prompt_type=="hybrid" & source=="values") %>% spread(key = "item", value = "prediction_clean")
...
### GPT item-level models (CCR style prompts) -- from Everyday essays
```{r}
#reformat data sets from long to wide for each construct separately
#only use responses from CCR style prompt
df_ccr_cons = df_results %>% filter(construct=="conservatism_tot" & prompt_type=="hybrid" & source=="behaviors") %>% spread(key = "item", value = "prediction_clean")
df_ccr_indi = df_results %>% filter(construct=="Individualism_tot" & prompt_type=="hybrid" & source=="behaviors") %>% spread(key = "item", value = "prediction_clean")
df_ccr_reli = df_results %>% filter(construct=="Religiosity_tot" & prompt_type=="hybrid" & source=="behaviors") %>% spread(key = "item", value = "prediction_clean")
df_ccr_coll = df_results %>% filter(construct=="Collectivism_tot" & prompt_type=="hybrid" & source=="behaviors") %>% spread(key = "item", value = "prediction_clean")
df_ccr_care = df_results %>% filter(construct=="CARE_tot" & prompt_type=="hybrid" & source=="behaviors") %>% spread(key = "item", value = "prediction_clean")
df_ccr_equa = df_results %>% filter(construct=="EQUALITY_tot" & prompt_type=="hybrid" & source=="behaviors") %>% spread(key = "item", value = "prediction_clean")
df_ccr_prop = df_results %>% filter(construct=="PROPORTIONALITY_tot" & prompt_type=="hybrid" & source=="behaviors") %>% spread(key = "item", value = "prediction_clean")
df_ccr_loya = df_results %>% filter(construct=="LOYALTY_tot" & prompt_type=="hybrid" & source=="behaviors") %>% spread(key = "item", value = "prediction_clean")
df_ccr_auth = df_results %>% filter(construct=="AUTHORITY_tot" & prompt_type=="hybrid" & source=="behaviors") %>% spread(key = "item", value = "prediction_clean")
df_ccr_puri = df_results %>% filter(construct=="PURITY_tot" & prompt_type=="hybrid" & source=="behaviors") %>% spread(key = "item", value = "prediction_clean")
df_ccr_nfc = df_results %>% filter(construct=="NFC_tot" & prompt_type=="hybrid" & source=="behaviors") %>% spread(key = "item", value = "prediction_clean")
df_ccr_tigh = df_results %>% filter(construct=="Tightness" & prompt_type=="hybrid" & source=="behaviors") %>% spread(key = "item", value = "prediction_clean")
df_ccr_sd = df_results %>% filter(construct=="PVQ_SD_tot" & prompt_type=="hybrid" & source=="behaviors") %>% spread(key = "item", value = "prediction_clean")
df_ccr_po = df_results %>% filter(construct=="PVQ_PO_tot" & prompt_type=="hybrid" & source=="behaviors") %>% spread(key = "item", value = "prediction_clean")
df_ccr_un = df_results %>% filter(construct=="PVQ_UN_tot" & prompt_type=="hybrid" & source=="behaviors") %>% spread(key = "item", value = "prediction_clean")
df_ccr_ac = df_results %>% filter(construct=="PVQ_AC_tot" & prompt_type=="hybrid" & source=="behaviors") %>% spread(key = "item", value = "prediction_clean")
df_ccr_se = df_results %>% filter(construct=="PVQ_SE_tot" & prompt_type=="hybrid" & source=="behaviors") %>% spread(key = "item", value = "prediction_clean")
df_ccr_st = df_results %>% filter(construct=="PVQ_ST_tot" & prompt_type=="hybrid" & source=="behaviors") %>% spread(key = "item", value = "prediction_clean")
df_ccr_co = df_results %>% filter(construct=="PVQ_CO_tot" & prompt_type=="hybrid" & source=="behaviors") %>% spread(key = "item", value = "prediction_clean")
df_ccr_tr = df_results %>% filter(construct=="PVQ_TR_tot" & prompt_type=="hybrid" & source=="behaviors") %>% spread(key = "item", value = "prediction_clean")
df_ccr_he = df_results %>% filter(construct=="PVQ_HE_tot" & prompt_type=="hybrid" & source=="behaviors") %>% spread(key = "item", value = "prediction_clean")
df_ccr_be = df_results %>% filter(construct=="PVQ_BE_tot" & prompt_type=="hybrid" & source=="behaviors") %>% spread(key = "item", value = "prediction_clean")
...
### reformat and add columns for essay type and model name
...
df_tot_cons = df_results %>% filter(construct=="conservatism_tot" & prompt_type=="general" & source=="values") %>% spread(key = "item", value = "prediction_clean")
df_tot_indi = df_results %>% filter(construct=="Individualism_tot" & prompt_type=="general" & source=="values") %>% spread(key = "item", value = "prediction_clean")
df_tot_reli = df_results %>% filter(construct=="Religiosity_tot" & prompt_type=="general" & source=="values") %>% spread(key = "item", value = "prediction_clean")
df_tot_coll = df_results %>% filter(construct=="Collectivism_tot" & prompt_type=="general" & source=="values") %>% spread(key = "item", value = "prediction_clean")
df_tot_care = df_results %>% filter(construct=="CARE_tot" & prompt_type=="general" & source=="values") %>% spread(key = "item", value = "prediction_clean")
df_tot_equa = df_results %>% filter(construct=="EQUALITY_tot" & prompt_type=="general" & source=="values") %>% spread(key = "item", value = "prediction_clean")
df_tot_prop = df_results %>% filter(construct=="PROPORTIONALITY_tot" & prompt_type=="general" & source=="values") %>% spread(key = "item", value = "prediction_clean")
df_tot_loya = df_results %>% filter(construct=="LOYALTY_tot" & prompt_type=="general" & source=="values") %>% spread(key = "item", value = "prediction_clean")
df_tot_auth = df_results %>% filter(construct=="AUTHORITY_tot" & prompt_type=="general" & source=="values") %>% spread(key = "item", value = "prediction_clean")
df_tot_puri = df_results %>% filter(construct=="PURITY_tot" & prompt_type=="general" & source=="values") %>% spread(key = "item", value = "prediction_clean")
df_tot_nfc = df_results %>% filter(construct=="NFC_tot" & prompt_type=="general" & source=="values") %>% spread(key = "item", value = "prediction_clean")
df_tot_tigh = df_results %>% filter(construct=="Tightness" & prompt_type=="general" & source=="values") %>% spread(key = "item", value = "prediction_clean")
df_tot_sd = df_results %>% filter(construct=="PVQ_SD_tot" & prompt_type=="general" & source=="values") %>% spread(key = "item", value = "prediction_clean")
df_tot_po = df_results %>% filter(construct=="PVQ_PO_tot" & prompt_type=="general" & source=="values") %>% spread(key = "item", value = "prediction_clean")
df_tot_un = df_results %>% filter(construct=="PVQ_UN_tot" & prompt_type=="general" & source=="values") %>% spread(key = "item", value = "prediction_clean")
df_tot_ac = df_results %>% filter(construct=="PVQ_AC_tot" & prompt_type=="general" & source=="values") %>% spread(key = "item", value = "prediction_clean")
df_tot_se = df_results %>% filter(construct=="PVQ_SE_tot" & prompt_type=="general" & source=="values") %>% spread(key = "item", value = "prediction_clean")
df_tot_st = df_results %>% filter(construct=="PVQ_ST_tot" & prompt_type=="general" & source=="values") %>% spread(key = "item", value = "prediction_clean")
df_tot_co = df_results %>% filter(construct=="PVQ_CO_tot" & prompt_type=="general" & source=="values") %>% spread(key = "item", value = "prediction_clean")
df_tot_tr = df_results %>% filter(construct=="PVQ_TR_tot" & prompt_type=="general" & source=="values") %>% spread(key = "item", value = "prediction_clean")
df_tot_he = df_results %>% filter(construct=="PVQ_HE_tot" & prompt_type=="general" & source=="values") %>% spread(key = "item", value = "prediction_clean")
df_tot_be = df_results %>% filter(construct=="PVQ_BE_tot" & prompt_type=="general" & source=="values") %>% spread(key = "item", value = "prediction_clean")
...
```{r}
# format data sets from long to wide for each construct separately
df_tot_cons = df_results %>% filter(construct=="conservatism_tot" & prompt_type=="general" & source=="behaviors") %>% spread(key = "item", value = "prediction_clean")
df_tot_indi = df_results %>% filter(construct=="Individualism_tot" & prompt_type=="general" & source=="behaviors") %>% spread(key = "item", value = "prediction_clean")
df_tot_reli = df_results %>% filter(construct=="Religiosity_tot" & prompt_type=="general" & source=="behaviors") %>% spread(key = "item", value = "prediction_clean")
df_tot_coll = df_results %>% filter(construct=="Collectivism_tot" & prompt_type=="general" & source=="behaviors") %>% spread(key = "item", value = "prediction_clean")
df_tot_care = df_results %>% filter(construct=="CARE_tot" & prompt_type=="general" & source=="behaviors") %>% spread(key = "item", value = "prediction_clean")
df_tot_equa = df_results %>% filter(construct=="EQUALITY_tot" & prompt_type=="general" & source=="behaviors") %>% spread(key = "item", value = "prediction_clean")
df_tot_prop = df_results %>% filter(construct=="PROPORTIONALITY_tot" & prompt_type=="general" & source=="behaviors") %>% spread(key = "item", value = "prediction_clean")
df_tot_loya = df_results %>% filter(construct=="LOYALTY_tot" & prompt_type=="general" & source=="behaviors") %>% spread(key = "item", value = "prediction_clean")
df_tot_auth = df_results %>% filter(construct=="AUTHORITY_tot" & prompt_type=="general" & source=="behaviors") %>% spread(key = "item", value = "prediction_clean")
df_tot_puri = df_results %>% filter(construct=="PURITY_tot" & prompt_type=="general" & source=="behaviors") %>% spread(key = "item", value = "prediction_clean")
df_tot_nfc = df_results %>% filter(construct=="NFC_tot" & prompt_type=="general" & source=="behaviors") %>% spread(key = "item", value = "prediction_clean")
df_tot_tigh = df_results %>% filter(construct=="Tightness" & prompt_type=="general" & source=="behaviors") %>% spread(key = "item", value = "prediction_clean")
df_tot_sd = df_results %>% filter(construct=="PVQ_SD_tot" & prompt_type=="general" & source=="behaviors") %>% spread(key = "item", value = "prediction_clean")
df_tot_po = df_results %>% filter(construct=="PVQ_PO_tot" & prompt_type=="general" & source=="behaviors") %>% spread(key = "item", value = "prediction_clean")
df_tot_un = df_results %>% filter(construct=="PVQ_UN_tot" & prompt_type=="general" & source=="behaviors") %>% spread(key = "item", value = "prediction_clean")
df_tot_ac = df_results %>% filter(construct=="PVQ_AC_tot" & prompt_type=="general" & source=="behaviors") %>% spread(key = "item", value = "prediction_clean")
df_tot_se = df_results %>% filter(construct=="PVQ_SE_tot" & prompt_type=="general" & source=="behaviors") %>% spread(key = "item", value = "prediction_clean")
df_tot_st = df_results %>% filter(construct=="PVQ_ST_tot" & prompt_type=="general" & source=="behaviors") %>% spread(key = "item", value = "prediction_clean")
df_tot_co = df_results %>% filter(construct=="PVQ_CO_tot" & prompt_type=="general" & source=="behaviors") %>% spread(key = "item", value = "prediction_clean")
df_tot_tr = df_results %>% filter(construct=="PVQ_TR_tot" & prompt_type=="general" & source=="behaviors") %>% spread(key = "item", value = "prediction_clean")
df_tot_he = df_results %>% filter(construct=="PVQ_HE_tot" & prompt_type=="general" & source=="behaviors") %>% spread(key = "item", value = "prediction_clean")
df_tot_be = df_results %>% filter(construct=="PVQ_BE_tot" & prompt_type=="general" & source=="behaviors") %>% spread(key = "item", value = "prediction_clean")
...
ggsave("../results/plots/r2_values.pdf", v_plot, height = 4, width=6, dpi = 150, device = "pdf")
```

```{r}
### Alternative barplot
# aggregate_data <- aggregate(r2 ~ construct + model, df_scores_final_value, mean)
# 
# v_plot <- ggplot(aggregate_data, aes(x = construct, y = r2, fill = model)) + 
#   geom_bar(stat = "identity", position = position_dodge()) +
#   geom_errorbar(aes(ymin = r2 - ci_ccr_values[1], ymax = r2 + ci_ccr_values[2]), width = .2, position = position_dodge(.9)) +
#   scale_fill_discrete(name="Method", breaks=c("ccr", "gpt", "gpt_ccr"),
#                       labels=c("CCR", "GPT (construct-level)", "GPT (item-level)")) +
#   labs(x = "Constructs", y = "Variance Explained (%)") +
#   theme_bw() +
...
###### Plots
v_plot <- ggplot(df_scores_final_behav, aes(x=construct,y=r2, color=model)) + geom_point() + theme_bw() + scale_color_discrete(name="Method", breaks=c("ccr", "gpt", "gpt_ccr"),
                         labels=c("CCR", "GPT (construct-level)", "GPT (item-level)")) +
...
ggsave("../results/plots/r2_behaviors.pdf", v_plot, height = 4, width=6, dpi = 150, device = "pdf")
```

```{r}
# ## Alternative barplot
# aggregate_data <- aggregate(r2 ~ construct + model, df_scores_final_behav, mean)
# 
# v_plot <- ggplot(aggregate_data, aes(x = construct, y = r2, fill = model)) +
#   geom_bar(stat = "identity", position = position_dodge()) +
#   geom_errorbar(aes(ymin = r2 - ci_ccr_values[1], ymax = r2 + ci_ccr_values[2]), width = .2, position = position_dodge(.9)) +
